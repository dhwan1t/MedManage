...
export default function PatientVitalsForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`/api/cases/${targetCaseId}/update-vitals`, {
        method: "PUT",
      ...
      // Success — navigate to recommendations with the caseId
      navigate(`/ambulance/recommendations/${targetCaseId}`);
    } catch (err) {
              ...
              <div className="space-y-1">
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={handleChange}
                    className="w-full p-3 pr-10 border border-gray-300 rounded-xl focus:ring-indigo-500 focus:border-indigo-500"
                    placeholder="40-200"
                  />
              ...
              <div className="space-y-1 sm:col-span-2 lg:col-span-1">
                ...
                <div className="flex items-center gap-2">
                  <input
                    ...
                    onChange={handleChange}
                    className="w-full p-3 border border-gray-300 rounded-xl focus:ring-indigo-500 focus:border-indigo-500 text-center"
                    placeholder="120"
                  />
              ...
              <div className="space-y-1">
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={handleChange}
                    className="w-full p-3 pr-8 border border-gray-300 rounded-xl focus:ring-indigo-500 focus:border-indigo-500"
                    placeholder="37.0"
                  />
              ...
              <div className="space-y-2">
                ...
                <div className="flex flex-wrap gap-3">
                  {CONSCIOUSNESS_LEVELS.map((level) => (
                    <label
                      key={level}
                      className={`flex-1 min-w-[120px] p-3 border rounded-xl cursor-pointer transition-colors text-center ${formData.consciousness === level ? "bg-indigo-50 border-indigo-500 text-indigo-700 font-bold" : "hover:bg-gray-50 border-gray-200 text-gray-600 font-medium"}`}
                    >
                      <input
                        required
                        type="radio"
              ...
              <div className="space-y-2 pt-2">
                ...
                <div className="grid grid-cols-2 gap-3">
                  {KNOWN_CONDITIONS.map((condition) => (
                    <label
                      key={condition}
                      className={`flex items-center p-3 border rounded-xl cursor-pointer transition-colors ${formData.conditions.includes(condition) ? "bg-indigo-50 border-indigo-500" : "hover:bg-gray-50 border-gray-200"}`}
                    >
                      <input
                        type="checkbox"
