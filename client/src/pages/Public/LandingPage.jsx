...
export default function LandingPage() {
            ...
            try {
                ...
                if (payloadBase64) {
                    ...
                    if (decodedObj && decodedObj.name) {
                        setUsername(decodedObj.name.split(' ')[0]); // Get first name
                    } else if (decodedObj && decodedObj.username) {
                        setUsername(decodedObj.username);
                    }
                }
            } catch (err) {
    ...
    return (
        <div className="min-h-screen bg-gray-50 font-sans pb-12 relative overflow-hidden">
            ...
            {/* Toast Notification */}
            <div className={`fixed top-4 left-1/2 transform -translate-x-1/2 z-50 transition-all duration-300 ${showToast ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-4 pointer-events-none'}`}>
            ...
            <div className="max-w-md mx-auto sm:max-w-2xl lg:max-w-4xl px-4 sm:px-6 lg:px-8 pt-8 space-y-8">
                ...
                <div className="flex gap-4 overflow-x-auto pb-2 -mx-4 px-4 sm:mx-0 sm:px-0 sm:grid sm:grid-cols-2 lg:grid-cols-2">
                    <div className="flex-none w-64 sm:w-auto bg-white p-4 rounded-2xl shadow-sm border border-orange-100 flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-sm font-semibold text-gray-500 mt-1">Active Alerts Near You</p>
                        </div>
                    </div>
                    ...
                    <div className="flex-none w-64 sm:w-auto bg-white p-4 rounded-2xl shadow-sm border border-blue-100 flex items-center gap-4">
                        ...
                        <div>
                            <p className="text-2xl font-bold text-gray-900 leading-none">2.1<span className="text-lg">km</span></p>
                            <p className="text-sm font-semibold text-gray-500 mt-1">Nearest Hospital</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                    ...
                    >
                        ...
                        <div>
                            ...
                            <p className="text-xs text-gray-500 mt-1 font-medium">View local outbreaks</p>
                        </div>
                    </button>
                    ...
                    >
                        ...
                        <div>
                            ...
                            <p className="text-xs text-gray-500 mt-1 font-medium">Self-diagnosis tool</p>
                        </div>
                    </button>
                    ...
                    >
                        ...
                        <div>
                            ...
                            <p className="text-xs text-gray-500 mt-1 font-medium">Emergency request</p>
                        </div>
                    </button>
                    ...
                    >
                        <div className="absolute top-0 right-0 bg-gray-100 text-gray-500 text-[10px] uppercase font-bold px-2 py-1 rounded-bl-lg">Soon</div>
                        ...
                        <div>
                            ...
                            <p className="text-xs text-gray-400 mt-1 font-medium">Find closest clinics</p>
                        </div>
                    </button>
                </div>
                ...
                <div className="pt-4">
                    <div className="flex justify-between items-end mb-4">
                        ...
                        <button onClick={() => navigate('/alerts')} className="text-sm font-bold text-indigo-600 hover:text-indigo-800 transition-colors">
                            View All
                        </button>
                    </div>

                    <div onClick={() => navigate('/alerts')} className={`cursor-pointer rounded-2xl border transition-all duration-200 hover:shadow-md hover:-translate-y-1 ${bgColors[latestAlert.severity]}`}>
                        <div className="p-5">
                            <div className="flex justify-between items-start mb-3">
                                <h3 className="text-lg font-bold text-gray-900">
                                    {latestAlert.name}
                                </h3>
                                <span className={`px-2 py-1 text-[10px] uppercase font-bold rounded-md shadow-sm ${severityColors[latestAlert.severity]}`}>
                            ...
                            <div className="flex items-center gap-4 text-sm">
                                <div className="flex items-center gap-1.5 text-gray-700">
                                    ...
                                    <span className="font-semibold">{latestAlert.cases} <span className="font-normal text-gray-500">cases</span></span>
                                </div>
                                <div className="flex items-center gap-1.5 text-gray-700">
                                    ...
                                    <span className="font-medium text-gray-600 truncate max-w-[120px] sm:max-w-none">{latestAlert.zones.join(", ")}</span>
                                </div>
                            </div>
                        </div>
                    </div>
